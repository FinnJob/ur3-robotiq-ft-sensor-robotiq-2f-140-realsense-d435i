...
namespace robotiq_3f_gripper_control
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(Robotiq3FGripperConfig &config, const Robotiq3FGripperConfig &max, const Robotiq3FGripperConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const Robotiq3FGripperConfig &config1, const Robotiq3FGripperConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, Robotiq3FGripperConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const Robotiq3FGripperConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, Robotiq3FGripperConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const Robotiq3FGripperConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const Robotiq3FGripperConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, Robotiq3FGripperConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.mode = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(Robotiq3FGripperConfig::AbstractParamDescriptionConstPtr(new Robotiq3FGripperConfig::ParamDescription<int>("mode", "int", 0, "The grasping mode", "{'enum': [{'name': 'Basic', 'type': 'int', 'value': 0, 'srcline': 37, 'srcfile': '/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Basic mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Pinch', 'type': 'int', 'value': 1, 'srcline': 38, 'srcfile': '/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Pinch mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Wide', 'type': 'int', 'value': 2, 'srcline': 39, 'srcfile': '/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Wide mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Scissor', 'type': 'int', 'value': 3, 'srcline': 40, 'srcfile': '/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Scissor mode', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set the grasp operation mode'}", &Robotiq3FGripperConfig::mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(Robotiq3FGripperConfig::AbstractParamDescriptionConstPtr(new Robotiq3FGripperConfig::ParamDescription<int>("mode", "int", 0, "The grasping mode", "{'enum': [{'name': 'Basic', 'type': 'int', 'value': 0, 'srcline': 37, 'srcfile': '/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Basic mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Pinch', 'type': 'int', 'value': 1, 'srcline': 38, 'srcfile': '/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Pinch mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Wide', 'type': 'int', 'value': 2, 'srcline': 39, 'srcfile': '/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Wide mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Scissor', 'type': 'int', 'value': 3, 'srcline': 40, 'srcfile': '/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Scissor mode', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set the grasp operation mode'}", &Robotiq3FGripperConfig::mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 37 "/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Basic = 0;
//#line 38 "/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Pinch = 1;
//#line 39 "/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Wide = 2;
//#line 40 "/home/zf/Documents/ROS/catkin_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
